...
var SearchBarDirective = (function () {
    function SearchBarDirective(el, renderer) {
        this.el = el;
        this.renderer = renderer;
    }
    SearchBarDirective.prototype.changeWidth = function (newWidth) {
        this.renderer.setElementStyle(this.el.nativeElement, 'width', newWidth);
    };
    SearchBarDirective.prototype.ngOnInit = function () {
        this.setInitialWidth();
    };
    SearchBarDirective.prototype.setInitialWidth = function () {
        this.renderer.setElementStyle(this.el.nativeElement, 'width', '250px');
    };
    SearchBarDirective.prototype.onMouseClick = function () {
        this.changeWidth('500px');
    };
    SearchBarDirective.prototype.onLoseFocus = function () {
        this.setInitialWidth();
    };
    __decorate([
    ...
    ], SearchBarDirective.prototype, "onMouseClick", null);
    __decorate([
